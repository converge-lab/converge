# The opencode agent image. The builder stage is byte-identical to the
# others on purpose: Docker shares the layer, so adding a harness costs
# an npm install, not another Rust build.
